...
def _psalm43_outputs() -> dict:
    o = deepcopy(_psalm42_outputs())
    o["source_agent"] = {
        "source_text": "Psalm 43: Vindicate me, God, and plead my cause against an unfaithful nation. Rescue me from the deceitful and unjust man. You are the God of my refuge. Why do I walk mourning under an enemy's oppression? Send Your light and Your truth; let them lead me. Bring me to Your holy mountain and dwelling. Then I will go to God's altar, to God my exceeding joy, and praise You with the lyre. Why are you bowed down, my living self? Wait for God, for I shall yet praise Him.",
        "chapter_verse_count": 5,
    }
    o["translator"] = {"working_rendering": "Vindicate me, God, and contend for my cause. Rescue me from deceit and injustice. You are the God of my refuge. Why must I walk in mourning under oppression? Send Your light and Your truth; let them lead me to Your holy mountain and dwelling. Then I will come to God's altar, to God my exceeding joy, and praise You with the lyre. Why are you bowed down, my living self? Wait for God, for I shall yet praise Him."}
    o["chapter_design_mapper"] = {
        "chapter_start": "A worshiper asks God to judge his cause under deceit and oppression.",
        "chapter_end": "The bowed-down living self waits for future praise.",
        "emotional_movement": "Public injustice and mourning move through a plea for guidance toward altar, joy, and future praise.",
        "divine_action": "God vindicates, rescues, sends light and truth, leads to His dwelling, and remains the ground of praise.",
        "physical_vocabulary": ["walk", "mourning", "light", "truth", "lead", "mountain", "dwelling", "altar", "lyre"],
        "central_theological_claim": "The God of refuge answers oppression by judging truthfully and leading the worshiper back toward His presence.",
        "christward_fulfillment": "Jesus is the light and truth who brings His people to the Father.",
        "reader_felt_experience": "A person under false accusation keeps walking under pressure while asking God for a truthful path forward.",
        "chapter_design_summary": "The psalm moves from vindication to mourning, guided pilgrimage, altar joy, and future praise.",
    }
    o["canonist"] = {"pathway": "Psalm 43 is not directly cited as prophecy. John 8:12 and John 14:6 provide a thematic correspondence: Christ is the light and truth who brings His people to the Father."}
    o["theological_risk_agent"] = {"risks": [
        {"risk_id": "R1", "risk_description": "Turn vindication into revenge.", "why_it_matters": "The worshiper places judgment with God.", "avoidance_rule": "Reject retaliation and preserve lawful protection.", "evaluator_check": "Application must not authorize revenge."},
        {"risk_id": "R2", "risk_description": "Reduce light and truth to mood.", "why_it_matters": "They lead toward mountain, dwelling, altar, and praise.", "avoidance_rule": "Keep the images directional and worship-centered.", "evaluator_check": "Guidance must lead toward God."},
    ]}
    o["historian_linguist"] = {"notes": "Light and truth are sent as guides toward God's holy dwelling."}
    o["commentary_agent"] = {"notes": "Psalm 43 shares Psalm 42's refrain but carries its own burden of vindication and guidance."}
    o["art_director"] = {
        "register": "restrained petition under public pressure",
        "pace": "judicial opening, embodied mourning, then forward movement toward worship",
        "sentence_music": "firm pleas opening into directional clauses",
        "image_density": "walking, light, road, mountain, dwelling, altar, lyre",
        "emotional_color": "grief becoming guided hope without premature triumph",
        ...
        "avoid": ["revenge", "vague illumination", "instant resolution"],
    }
    o["creative_divergence_agent"] = {
        "threshold_phrase_candidates": ["Truth must lead somewhere.", "Send light for the next step.", "The road bends toward the altar.", "Mourning still has a direction.", "The judge's seat remains with God."],
    ...
    o["director"] = {
        "chapter_burden": "The oppressed worshiper entrusts vindication to God and asks for light and truth to lead him toward God's presence.",
        ...
        "emotional_charge": "grief earned through the gait of a person still walking under pressure",
        "transcendent_force": "God's light and truth moving as guides toward His dwelling",
        "selected_threshold_phrase": "Truth must lead somewhere.",
        "threshold_phrase_rationale": "The line preserves the psalm's directional logic.",
        ...
        "christology_pathway": "A thematic correspondence links God's sent light and truth with Christ, the light of the world and the truth who brings His people to the Father.",
        ...
        "negative_constraints": ["emotion_earned_by_physical_fact", "no_unwarranted_deprivation", "do not endorse revenge", "do not reduce light to mood", "do not impose instant resolution"],
        "poem_plan": "common meter moving from a dark road to the holy mountain and altar praise",
    ...
    o["composer"] = {
        ...
        "focus_bible_verses": "Psalm 43:1-5 — Vindicate me, God. Send Your light and Your truth; let them lead me. Let them bring me to Your holy mountain and dwelling. Then I will go to God's altar, to God my exceeding joy.",
        "introduction": "Truth must lead somewhere.\n\nThe worshiper is still walking. Oppression has changed his pace, but not his direction. His steps carry the mourning before he names it. He asks God to judge his cause because he will not seize the judge's seat for himself.",
...
def test_psalm43_runs_full_v64_pipeline_separately() -> None:
    ...
    assert "mourning has a gait" in ctx.prose["reflection"].lower()
