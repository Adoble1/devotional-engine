...
def main() -> None:
    outputs = json.loads((Path(__file__).with_name("psalm20_mock_outputs.json")).read_text())
    ctx = run_engine(EngineContext(chapter_ref="Psalm 20"), MockAgentAdapter(outputs))
